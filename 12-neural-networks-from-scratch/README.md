# Module 12: Neural Networks from Scratch

## 🎯 Learning Objectives

By the end of this module, you will master:
- Build complete neural network with NumPy only
...
```bash
# View examples
uv run 12-neural-networks-from-scratch/examples.py

# Do exercises
uv run 12-neural-networks-from-scratch/exercises.py

# Check solutions
uv run 12-neural-networks-from-scratch/solutions.py
```
...
**Ready? Let's master Neural Networks from Scratch!** 🚀
