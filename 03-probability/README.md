...
```bash
# View examples
uv run 03-probability/examples.py

# Do exercises
uv run 03-probability/exercises.py

# Check solutions
uv run 03-probability/solutions.py
```
...
**Ready? Let's master Probability Theory!** 🚀
