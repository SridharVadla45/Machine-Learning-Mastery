...
- Cross-validation, metrics, ROC curves, calibration
...
```bash
# View examples
uv run 10-model-evaluation/examples.py

# Do exercises
uv run 10-model-evaluation/exercises.py

# Check solutions
uv run 10-model-evaluation/solutions.py
```
...
**Ready? Let's master Model Evaluation!** 🚀
