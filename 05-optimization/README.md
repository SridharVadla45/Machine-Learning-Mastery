# Module 05: Optimization Theory

## 🎯 Learning Objectives

By the end of this module, you will master:
- Gradient descent, convex optimization, constraints
...
```bash
# View examples
uv run 05-optimization/examples.py

# Do exercises
uv run 05-optimization/exercises.py

# Check solutions
uv run 05-optimization/solutions.py
```
...
**Ready? Let's master Optimization Theory!** 🚀
