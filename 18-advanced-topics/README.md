...
- GANs, RL, AutoML, interpretability
...
```bash
# View examples
uv run 18-advanced-topics/examples.py

# Do exercises
uv run 18-advanced-topics/exercises.py

# Check solutions
uv run 18-advanced-topics/solutions.py
```
...
**Ready? Let's master Advanced Topics!** 🚀
