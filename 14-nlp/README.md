...
- Word embeddings, RNNs, Transformers, BERT
...
```bash
# View examples
uv run 14-nlp/examples.py

# Do exercises
uv run 14-nlp/exercises.py

# Check solutions
uv run 14-nlp/solutions.py
```
...
**Ready? Let's master Natural Language Processing!** 🚀
