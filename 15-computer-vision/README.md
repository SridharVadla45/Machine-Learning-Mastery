...
- CNNs, ResNets, object detection, segmentation
...
```bash
# View examples
uv run 15-computer-vision/examples.py

# Do exercises
uv run 15-computer-vision/exercises.py

# Check solutions
uv run 15-computer-vision/solutions.py
```
...
**Ready? Let's master Computer Vision!** 🚀
