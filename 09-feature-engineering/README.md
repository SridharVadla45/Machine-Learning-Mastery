...
- Scaling, encoding, selection, dimensionality reduction
...
```bash
# View examples
uv run 09-feature-engineering/examples.py

# Do exercises
uv run 09-feature-engineering/exercises.py

# Check solutions
uv run 09-feature-engineering/solutions.py
```
...
**Ready? Let's master Feature Engineering!** 🚀
