...
- K-means, PCA, DBSCAN, hierarchical clustering
...
```bash
# View examples
uv run 08-unsupervised-learning/examples.py

# Do exercises
uv run 08-unsupervised-learning/exercises.py

# Check solutions
uv run 08-unsupervised-learning/solutions.py
```
...
**Ready? Let's master Unsupervised Learning!** 🚀
